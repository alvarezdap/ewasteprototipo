...
def anadir_tipo_desecho():
    option_celular = st.selectbox('Celular',('Samsung','Iphone','Huawei','Xiaomi'), index=1)
    option_cantidad = st.selectbox('Cantidad', ('0-5','5-10','10-20'))
    option_computadoras = st.selectbox('Computadoras',('Laptops','PCs'), index=2)
    option_computadora = st.selectbox('Cantidad', ('0-5','5-10','10-20'))
...
df = pd.DataFrame(
    rng(0).standard_normal((50, 2)) / [-1.56] + [-78.183406],
    columns=["lat", "lon"],
)
